...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { Description: @gift.Description, Person_id: @gift.Person_id, Summary: @gift.Summary, cost: @gift.cost }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { Description: @gift.Description, Person_id: @gift.Person_id, Summary: @gift.Summary, cost: @gift.cost }
    assert_redirected_to gift_path(assigns(:gift))
  end
